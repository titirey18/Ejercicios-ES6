...
const Search = numbers.find((numbers) => numbers === 100)
...
const searchMovie = movies.find((movies) => movies.date > 2011)
...
const SearchAliens = aliens.find((aliens) => aliens.name === 'Cucushumushu')
const SearchMutations = mutations.find(
  (mutations) => mutations.name === 'Porompompero'
)

const Fusion = { ...SearchAliens, mutation: { ...SearchMutations } }
